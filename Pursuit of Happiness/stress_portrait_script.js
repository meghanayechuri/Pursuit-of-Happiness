...
********************************/
  ...
  .data(arrayOfPolygons)
    ...
    .on("click", function(d){
      ...
      console.log(selectedStressors)});
    
    /* 
        Get the button and add an event listener to send the url to the next page.
        Also, pass stressor array VIA url 
    */
